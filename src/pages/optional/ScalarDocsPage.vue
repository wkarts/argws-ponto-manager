...
function isWebProxyRuntime(): boolean {
  ...
  const win = window as Window & { ARGWS_PONTO_MANAGER_COMMAND_PROXY_BASE?: string; ARGWS_PONTO_MANAGER_WEB_RUNTIME?: boolean; ARGWS_PONTO_MANAGER_INTERNAL_API_WEB_RUNTIME?: boolean };
  return !isTauriRuntime() && Boolean(win.ARGWS_PONTO_MANAGER_COMMAND_PROXY_BASE || win.ARGWS_PONTO_MANAGER_WEB_RUNTIME || win.ARGWS_PONTO_MANAGER_INTERNAL_API_WEB_RUNTIME || window.location.port === "61002");
}
