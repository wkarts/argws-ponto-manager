...
<template>
  <div class="grid page-gap cartao-vb6-page">
    ...
    <div class="cartao-vb6-shell">
      ...
      <div class="cartao-vb6-side sticky-card" :class="{ collapsed: sidebarCollapsed }">
        <button class="side-collapse-btn" type="button" @click="toggleSidebar" :title="sidebarCollapsed ? 'Expandir sidebar' : 'Recolher sidebar'">
          {{ sidebarCollapsed ? '◀' : '▶' }}
        </button>
