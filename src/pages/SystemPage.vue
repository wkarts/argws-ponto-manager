...
function persistWorkspaceTabsPreference() {
  ...
  window.dispatchEvent(new CustomEvent("ponto-manager:workspace-tabs-preference-changed", { detail: { enabled: workspaceTabsEnabled.value } }));
}
...
<template>
  <BasePage title="Sistema e parâmetros" subtitle="Configuração organizada dos serviços, portas, acesso de rede, diretórios e execução.">
    ...
    <BaseSectionCard title="Diretório de dados/parâmetros" subtitle="Use um diretório próprio no app derivado para não gravar dados em argws_ponto_manager.">
