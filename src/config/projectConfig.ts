...
export const projectConfig = {
  app: {
    ...
    developer: "ARGWS",
    localDataDir: "argws-ponto-manager",
    storagePrefix: "argws-ponto-manager",
    supportUrl: "",
    documentationUrl: "",
  },
  features: {
  ...
  database: {
    ...
    sqlite: { path: "ponto-manager.db" },
    mysql: { host: "127.0.0.1", port: 3306, database: "argws_ponto_manager", username: "root", password: "" },
    postgres: { host: "127.0.0.1", port: 5432, database: "argws_ponto_manager", username: "postgres", password: "" },
    firebird: {
      supported: false,
      scope: "out-of-scope",
