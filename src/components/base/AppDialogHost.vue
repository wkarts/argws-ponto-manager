...
onMounted(() => {
  window.addEventListener("argws-ponto-manager:dialog", onDialogRequest as EventListener);
  window.addEventListener("keydown", handleKeydown);
});

onBeforeUnmount(() => {
  window.removeEventListener("argws-ponto-manager:dialog", onDialogRequest as EventListener);
