...
APP_ID="argws-ponto-manager"
CRATE_NAME="argws_ponto_manager"
...
Ponto Manager CloudPanel Release
Versão: $VERSION
...
Portas configuráveis via .env:
  API:       ARGWS_PONTO_MANAGER_API_HOST / ARGWS_PONTO_MANAGER_API_PORT      (padrão 127.0.0.1:61001)
  WebPort:   ARGWS_PONTO_MANAGER_WEB_HOST / ARGWS_PONTO_MANAGER_WEB_PORT      (padrão 127.0.0.1:61002 ou PORT do CloudPanel)
  Webhook:   ARGWS_PONTO_MANAGER_WEBHOOK_HOST / ARGWS_PONTO_MANAGER_WEBHOOK_PORT (padrão 127.0.0.1:61003)
  WebSocket: ARGWS_PONTO_MANAGER_WEBSOCKET_HOST / ARGWS_PONTO_MANAGER_WEBSOCKET_PORT (padrão 127.0.0.1:61004)
