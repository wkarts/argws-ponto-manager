...
const INTERNAL_API_PORT_DEFINITION: RuntimePortDefinition = RuntimePortDefinition {
    key: "internal_api",
    label: "API interna",
    env_host_key: "ARGWS_PONTO_MANAGER_API_HOST",
    env_port_key: "ARGWS_PONTO_MANAGER_API_PORT",
    default_port: INTERNAL_API_DEFAULT_PORT,
    description: "API local Axum do Ponto Manager nos modos desktop e headless.",
};

const LOCAL_WEB_PORT_DEFINITION: RuntimePortDefinition = RuntimePortDefinition {
    key: "local_web",
    label: "Servidor web local",
    env_host_key: "ARGWS_PONTO_MANAGER_WEB_HOST",
    env_port_key: "ARGWS_PONTO_MANAGER_WEB_PORT",
...
const AUXILIARY_PORT_DEFINITION: RuntimePortDefinition = RuntimePortDefinition {
    ...
    env_host_key: "ARGWS_PONTO_MANAGER_WEBHOOK_HOST",
    env_port_key: "ARGWS_PONTO_MANAGER_WEBHOOK_PORT",
...
const BRIDGE_CORE_PORT_DEFINITION: RuntimePortDefinition = RuntimePortDefinition {
    ...
    env_host_key: "ARGWS_PONTO_MANAGER_WEBSOCKET_HOST",
    env_port_key: "ARGWS_PONTO_MANAGER_WEBSOCKET_PORT",
...
impl Default for RuntimeSettings {
    fn default() -> Self {
        Self {
            internal_api_host: env_string("ARGWS_PONTO_MANAGER_API_HOST", "127.0.0.1"),
            internal_api_port: env_u16("ARGWS_PONTO_MANAGER_API_PORT", INTERNAL_API_DEFAULT_PORT),
            internal_api_base_url: env_string(
                "ARGWS_PONTO_MANAGER_API_BASE_URL",
                "http://127.0.0.1:61001",
            ),
            internal_api_docs_url: env_string(
                "ARGWS_PONTO_MANAGER_API_SCALAR_URL",
                "http://127.0.0.1:61001/docs",
            ),
            internal_api_auto_start: env_bool("ARGWS_PONTO_MANAGER_API_AUTO_START", true),
            internal_api_restart_on_config_change: env_bool(
                "ARGWS_PONTO_MANAGER_API_RESTART_ON_CONFIG_CHANGE",
                true,
            ),
            internal_api_require_token: env_bool("ARGWS_PONTO_MANAGER_API_REQUIRE_TOKEN", true),
            internal_api_allow_public_network: env_bool(
                "ARGWS_PONTO_MANAGER_API_ALLOW_PUBLIC_NETWORK",
                false,
            ),
            internal_api_cors_enabled: env_bool("ARGWS_PONTO_MANAGER_API_CORS", false),
            internal_api_token_header: env_string(
                "ARGWS_PONTO_MANAGER_API_TOKEN_HEADER",
                "X-App-Token",
            ),
            internal_api_token: env_string("ARGWS_PONTO_MANAGER_API_TOKEN", ""),
            internal_api_docs_public_local: env_bool(
                "ARGWS_PONTO_MANAGER_API_DOCS_PUBLIC_LOCAL",
                true,
            ),
            internal_api_open_scalar_after_start: env_bool(
                "ARGWS_PONTO_MANAGER_API_OPEN_SCALAR_AFTER_START",
                false,
            ),
            internal_api_timeout_ms: env_u64("ARGWS_PONTO_MANAGER_API_TIMEOUT_MS", 8000),
            internal_api_log_mode: env_string("ARGWS_PONTO_MANAGER_API_LOG_MODE", "normal"),
            internal_api_docs_enabled: env_bool("ARGWS_PONTO_MANAGER_API_SCALAR_ENABLED", true),
            internal_api_docs_path: env_string("ARGWS_PONTO_MANAGER_API_DOCS_PATH", "/docs"),
            local_web_enabled: env_bool(
                "ARGWS_PONTO_MANAGER_WEB_ENABLED",
                !env_bool("ARGWS_PONTO_MANAGER_WEB_DISABLED", false),
            ),
            local_web_auto_start: env_bool("ARGWS_PONTO_MANAGER_WEB_AUTO_START", true),
            local_web_host: env_string("ARGWS_PONTO_MANAGER_WEB_HOST", "127.0.0.1"),
            local_web_port: env_u16("ARGWS_PONTO_MANAGER_WEB_PORT", LOCAL_WEB_DEFAULT_PORT),
            auxiliary_host: env_string("ARGWS_PONTO_MANAGER_WEBHOOK_HOST", "127.0.0.1"),
            auxiliary_port: env_u16("ARGWS_PONTO_MANAGER_WEBHOOK_PORT", AUXILIARY_DEFAULT_PORT),
            bridge_core_host: env_string("ARGWS_PONTO_MANAGER_WEBSOCKET_HOST", "127.0.0.1"),
            bridge_core_port: env_u16(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_PORT",
                BRIDGE_CORE_DEFAULT_PORT,
            ),
            webhook_enabled: env_bool("ARGWS_PONTO_MANAGER_WEBHOOK_ENABLED", false),
            webhook_auto_start: env_bool("ARGWS_PONTO_MANAGER_WEBHOOK_AUTO_START", false),
            webhook_host: env_string("ARGWS_PONTO_MANAGER_WEBHOOK_HOST", "127.0.0.1"),
            webhook_port: env_u16("ARGWS_PONTO_MANAGER_WEBHOOK_PORT", AUXILIARY_DEFAULT_PORT),
            webhook_base_path: env_string("ARGWS_PONTO_MANAGER_WEBHOOK_BASE_PATH", "/webhooks"),
            webhook_token_required: env_bool("ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_REQUIRED", true),
            webhook_token_header: env_string(
                "ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_HEADER",
                "X-Webhook-Token",
            ),
            webhook_token: env_string("ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN", ""),
            webhook_allow_lan: env_bool("ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_LAN", false),
            webhook_allow_external: env_bool("ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_EXTERNAL", false),
            websocket_enabled: env_bool("ARGWS_PONTO_MANAGER_WEBSOCKET_ENABLED", false),
            websocket_auto_start: env_bool("ARGWS_PONTO_MANAGER_WEBSOCKET_AUTO_START", false),
            websocket_host: env_string("ARGWS_PONTO_MANAGER_WEBSOCKET_HOST", "127.0.0.1"),
            websocket_port: env_u16(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_PORT",
                BRIDGE_CORE_DEFAULT_PORT,
            ),
            websocket_path: env_string("ARGWS_PONTO_MANAGER_WEBSOCKET_PATH", "/ws"),
            websocket_token_required: env_bool(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_REQUIRED",
                true,
            ),
            websocket_token_query: env_string("ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_QUERY", "token"),
            websocket_token_header: env_string(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_HEADER",
                "X-WebSocket-Token",
            ),
            websocket_token: env_string("ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN", ""),
            websocket_allow_lan: env_bool("ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_LAN", false),
            websocket_allow_external: env_bool(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_EXTERNAL",
                false,
            ),
            websocket_heartbeat_seconds: env_u64(
                "ARGWS_PONTO_MANAGER_WEBSOCKET_HEARTBEAT_SECONDS",
                30,
            ),
            tray_enabled: env_bool("ARGWS_PONTO_MANAGER_TRAY_ENABLED", true),
            minimize_to_tray: env_bool("ARGWS_PONTO_MANAGER_TRAY_MINIMIZE_TO_TRAY", true),
            close_to_tray: env_bool("ARGWS_PONTO_MANAGER_TRAY_CLOSE_TO_TRAY", false),
            start_with_windows: env_bool("ARGWS_PONTO_MANAGER_START_WITH_WINDOWS", false),
            services_auto_start: env_bool("ARGWS_PONTO_MANAGER_SERVICES_AUTO_START", false),
            app_service_name: env_string(
                "ARGWS_PONTO_MANAGER_SERVICE_NAME",
                "ArgwsPontoManagerServer",
            ),
        }
    }
}
...
pub fn env_file_path(state: Option<&SharedState>) -> Result<PathBuf, String> {
    if let Ok(path) = env::var("ARGWS_PONTO_MANAGER_ENV_FILE") {
    ...
    Ok(config_dir.join("argws_ponto_manager").join(ENV_FILE_NAME))
}
...
pub fn default_env_template() -> String {
    r#"# Ponto Manager - configuração local
# A porta padrão do Tauri (devUrl 1420) não é alterada por este arquivo.
ARGWS_PONTO_MANAGER_API_HOST=127.0.0.1
ARGWS_PONTO_MANAGER_API_PORT=61001
ARGWS_PONTO_MANAGER_API_AUTO_START=true
ARGWS_PONTO_MANAGER_API_BASE_URL=http://127.0.0.1:61001
ARGWS_PONTO_MANAGER_API_SCALAR_ENABLED=true
ARGWS_PONTO_MANAGER_API_SCALAR_URL=http://127.0.0.1:61001/docs
ARGWS_PONTO_MANAGER_API_DOCS_PATH=/docs
ARGWS_PONTO_MANAGER_API_DOCS_PUBLIC_LOCAL=true
ARGWS_PONTO_MANAGER_API_RESTART_ON_CONFIG_CHANGE=true
ARGWS_PONTO_MANAGER_API_OPEN_SCALAR_AFTER_START=false
ARGWS_PONTO_MANAGER_API_TIMEOUT_MS=8000
ARGWS_PONTO_MANAGER_API_LOG_MODE=normal
ARGWS_PONTO_MANAGER_WEB_ENABLED=true
ARGWS_PONTO_MANAGER_WEB_HOST=127.0.0.1
ARGWS_PONTO_MANAGER_WEB_PORT=61002
ARGWS_PONTO_MANAGER_WEB_AUTO_START=true
ARGWS_PONTO_MANAGER_WEB_BIND_LAN=false
ARGWS_PONTO_MANAGER_WEBHOOK_AUTO_START=false
ARGWS_PONTO_MANAGER_WEBHOOK_ENABLED=false
ARGWS_PONTO_MANAGER_WEBHOOK_HOST=127.0.0.1
ARGWS_PONTO_MANAGER_WEBHOOK_PORT=61003
ARGWS_PONTO_MANAGER_WEBHOOK_BASE_PATH=/webhooks
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_REQUIRED=true
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_HEADER=X-Webhook-Token
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN=
ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_LAN=false
ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_EXTERNAL=false
ARGWS_PONTO_MANAGER_WEBSOCKET_ENABLED=false
ARGWS_PONTO_MANAGER_WEBSOCKET_AUTO_START=false
ARGWS_PONTO_MANAGER_WEBSOCKET_HOST=127.0.0.1
ARGWS_PONTO_MANAGER_WEBSOCKET_PORT=61004
ARGWS_PONTO_MANAGER_WEBSOCKET_PATH=/ws
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_REQUIRED=true
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_QUERY=token
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_HEADER=X-WebSocket-Token
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN=
ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_LAN=false
ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_EXTERNAL=false
ARGWS_PONTO_MANAGER_WEBSOCKET_HEARTBEAT_SECONDS=30
ARGWS_PONTO_MANAGER_TRAY_ENABLED=true
ARGWS_PONTO_MANAGER_TRAY_MINIMIZE_TO_TRAY=true
ARGWS_PONTO_MANAGER_TRAY_CLOSE_TO_TRAY=false
ARGWS_PONTO_MANAGER_START_WITH_WINDOWS=false
ARGWS_PONTO_MANAGER_SERVICES_AUTO_START=false
ARGWS_PONTO_MANAGER_SERVICE_NAME=ArgwsPontoManagerServer
ARGWS_PONTO_MANAGER_API_REQUIRE_TOKEN=true
ARGWS_PONTO_MANAGER_API_ALLOW_PUBLIC_NETWORK=false
ARGWS_PONTO_MANAGER_API_CORS=false
ARGWS_PONTO_MANAGER_API_TOKEN=
ARGWS_PONTO_MANAGER_API_TOKEN_HEADER=X-App-Token
# Informe ARGWS_PONTO_MANAGER_API_TOKEN via secret/env real em produção; não commite tokens.
"#
    .to_string()
}

fn apply_env_from_settings(settings: &RuntimeSettings) {
    env::set_var("ARGWS_PONTO_MANAGER_API_HOST", &settings.internal_api_host);
    env::set_var(
        "ARGWS_PONTO_MANAGER_API_PORT",
    ...
    env::set_var(
        "ARGWS_PONTO_MANAGER_API_AUTO_START",
    ...
    env::set_var("ARGWS_PONTO_MANAGER_WEB_HOST", &settings.local_web_host);
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEB_PORT",
        settings.local_web_port.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEB_AUTO_START",
        settings.local_web_auto_start.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEB_BIND_LAN",
        (settings.local_web_host == "0.0.0.0").to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBHOOK_ENABLED",
        settings.webhook_enabled.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBHOOK_AUTO_START",
        settings.webhook_auto_start.to_string(),
    );
    env::set_var("ARGWS_PONTO_MANAGER_WEBHOOK_HOST", &settings.webhook_host);
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBHOOK_PORT",
        settings.webhook_port.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_LAN",
        settings.webhook_allow_lan.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBSOCKET_ENABLED",
        settings.websocket_enabled.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBSOCKET_AUTO_START",
        settings.websocket_auto_start.to_string(),
    );
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBSOCKET_HOST",
    ...
    env::set_var(
        "ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_LAN",
...
fn write_env_file(path: &Path, settings: &RuntimeSettings) -> Result<(), String> {
    let content = format!(
        "# Ponto Manager - gerado pela tela Sistema e parâmetros\n\
ARGWS_PONTO_MANAGER_API_HOST={}\n\
ARGWS_PONTO_MANAGER_API_PORT={}\n\
ARGWS_PONTO_MANAGER_API_BASE_URL={}\n\
ARGWS_PONTO_MANAGER_API_AUTO_START={}\n\
ARGWS_PONTO_MANAGER_API_RESTART_ON_CONFIG_CHANGE={}\n\
ARGWS_PONTO_MANAGER_API_REQUIRE_TOKEN={}\n\
ARGWS_PONTO_MANAGER_API_ALLOW_PUBLIC_NETWORK={}\n\
ARGWS_PONTO_MANAGER_API_CORS={}\n\
ARGWS_PONTO_MANAGER_API_TOKEN_HEADER={}\n\
ARGWS_PONTO_MANAGER_API_TOKEN={}\n\
ARGWS_PONTO_MANAGER_API_DOCS_PUBLIC_LOCAL={}\n\
ARGWS_PONTO_MANAGER_API_OPEN_SCALAR_AFTER_START={}\n\
ARGWS_PONTO_MANAGER_API_TIMEOUT_MS={}\n\
ARGWS_PONTO_MANAGER_API_LOG_MODE={}\n\
ARGWS_PONTO_MANAGER_API_SCALAR_ENABLED={}\n\
ARGWS_PONTO_MANAGER_API_SCALAR_URL={}\n\
ARGWS_PONTO_MANAGER_API_DOCS_PATH={}\n\
ARGWS_PONTO_MANAGER_WEB_ENABLED={}\n\
ARGWS_PONTO_MANAGER_WEB_HOST={}\n\
ARGWS_PONTO_MANAGER_WEB_PORT={}\n\
ARGWS_PONTO_MANAGER_WEB_AUTO_START={}\n\
ARGWS_PONTO_MANAGER_WEB_BIND_LAN={}\n\
ARGWS_PONTO_MANAGER_AUX_HOST={}\n\
ARGWS_PONTO_MANAGER_AUX_PORT={}\n\
ARGWS_PONTO_MANAGER_BRIDGE_HOST={}\n\
ARGWS_PONTO_MANAGER_BRIDGE_PORT={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_ENABLED={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_AUTO_START={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_HOST={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_PORT={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_BASE_PATH={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_REQUIRED={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN_HEADER={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_TOKEN={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_LAN={}\n\
ARGWS_PONTO_MANAGER_WEBHOOK_ALLOW_EXTERNAL={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_ENABLED={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_AUTO_START={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_HOST={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_PORT={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_PATH={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_REQUIRED={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_QUERY={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN_HEADER={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_TOKEN={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_LAN={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_ALLOW_EXTERNAL={}\n\
ARGWS_PONTO_MANAGER_WEBSOCKET_HEARTBEAT_SECONDS={}\n\
ARGWS_PONTO_MANAGER_TRAY_ENABLED={}\n\
ARGWS_PONTO_MANAGER_TRAY_MINIMIZE_TO_TRAY={}\n\
ARGWS_PONTO_MANAGER_TRAY_CLOSE_TO_TRAY={}\n\
ARGWS_PONTO_MANAGER_START_WITH_WINDOWS={}\n\
ARGWS_PONTO_MANAGER_SERVICES_AUTO_START={}\n\
ARGWS_PONTO_MANAGER_SERVICE_NAME={}\n\
# Informe ARGWS_PONTO_MANAGER_API_TOKEN via secret/env real em produção; não commite tokens.\n",
...
fn normalize_runtime_settings(settings: &mut RuntimeSettings) {
    ...
    if settings.app_service_name.trim().is_empty() {
        settings.app_service_name = "ArgwsPontoManagerServer".to_string();
    }
}
