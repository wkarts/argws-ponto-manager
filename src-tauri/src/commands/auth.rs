...
pub(crate) const PERMISSION_CATALOG: [(&str, &str); 37] = [
    ...
    ("feriados:view", "Visualizar tabela de feriados"),
    ("feriados:manage", "Gerenciar tabela de feriados"),
    ("ferias:view", "Visualizar férias de colaboradores"),
    ("ferias:create", "Lançar férias de colaboradores"),
    ("ferias:update", "Editar férias de colaboradores"),
    ("ferias:cancel", "Cancelar férias de colaboradores"),
    ("ferias:delete", "Excluir férias de colaboradores"),
