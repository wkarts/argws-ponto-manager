...
fn migrate_existing_schema(conn: &rusqlite::Connection) -> Result<(), String> {
    for (table, column, definition) in [
        ...
        ("jornadas_trabalho", "permite_folga_movel", "INTEGER NOT NULL DEFAULT 0"),
        ("jornadas_trabalho", "permite_meia_folga", "INTEGER NOT NULL DEFAULT 0"),
        ("jornadas_trabalho", "dia_folga_base", "INTEGER"),
        ("jornadas_trabalho", "periodo_meia_folga", "TEXT"),
        ("jornadas_trabalho", "heuristica_troca_folga", "INTEGER NOT NULL DEFAULT 1"),
