...
pub fn migrate(db_path: &Path) -> Result<(), String> {
    ...
    conn.execute_batch(
        ...
        CREATE TABLE IF NOT EXISTS equipamentos (
            ...
            conector_base_url TEXT,
            conector_api_token TEXT,
            conector_timeout INTEGER NOT NULL DEFAULT 30,
...
fn migrate_existing_schema(conn: &rusqlite::Connection) -> Result<(), String> {
    for (table, column, definition) in [
        ...
        ("ferias_colaboradores", "cancelado_em", "TEXT"),
        ("ferias_colaboradores", "cancelado_por", "INTEGER"),
        ("ferias_colaboradores", "motivo_cancelamento", "TEXT"),
